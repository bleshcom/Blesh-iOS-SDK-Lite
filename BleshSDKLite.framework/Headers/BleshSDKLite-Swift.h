...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BleshSDKLite",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (void)startWithSecretKey:(NSString * _Nonnull)key withConfiguration:(BleshSdkConfiguration * _Nonnull)configuration;
- (void)startWithSecretKey:(NSString * _Nonnull)key withConfiguration:(BleshSdkConfiguration * _Nonnull)configuration completion:(void (^ _Nonnull)(BOOL))completion;
- (void)startWithSecretKey:(NSString * _Nonnull)key withApplicationUser:(BleshSdkApplicationUser * _Nonnull)applicationUser;
- (void)startWithSecretKey:(NSString * _Nonnull)key withApplicationUser:(BleshSdkApplicationUser * _Nonnull)applicationUser completion:(void (^ _Nonnull)(BOOL))completion;
...
SWIFT_CLASS("_TtC12BleshSDKLite23BleshSdkApplicationUser")
@interface BleshSdkApplicationUser : NSObject
- (nonnull instancetype)initWithUserId:(NSString * _Nullable)UserId Gender:(NSNumber * _Nullable)Gender YearOfBirth:(NSNumber * _Nullable)YearOfBirth Email:(NSString * _Nullable)Email PhoneNumber:(NSString * _Nullable)PhoneNumber Other:(NSDictionary<NSString *, NSString *> * _Nullable)Other OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC12BleshSDKLite21BleshSdkConfiguration")
